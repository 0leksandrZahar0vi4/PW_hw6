...
for group_id in range(1, 4):
    for _ in range(10):
        cur.execute("INSERT INTO users (name, email, age, group_id) VALUES (%s, %s)",
                    (fake.name(), fake.email(), random.randint(18,61), group_id))
    ...
    for subjects_id in range(1, 3):
        for _ in range(10):
            cur.execute("INSERT INTO grades (user_id, subjects_id, grade, grade_date) VALUES (%s, %s, %s, %s)",
                        (users_id, subjects_id, random.randint(60, 100), fake.date_this_decade()))
